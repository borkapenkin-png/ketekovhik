...
const QUICK_FACTS = [
    {
        ...
        value: "100",
        label: "külalist",
        detail: "Avar saal sünnipäevaks, juubeliks või firmaõhtuks."
    },
    {
        icon: <Soup size={18} />,
        value: "3",
        label: "lahendust",
        detail: "Peosaal, kohvilaud või toitlustusega terviklahendus."
    },
    {
        icon: <Clock3 size={18} />,
        value: "1",
        label: "päring",
        detail: "Kirjelda soovid ära ja saame teha personaalse pakkumise."
    }
];
...
export default function EventQuoteSectionManaged({ imageUrl, content = DEFAULT_CONTENT }) {
                        ...
                        <div className="quote-image-panel">
                            <div className="quote-atmosphere-panel">
                                <div className="quote-atmosphere-header">
                                    ...
                                    <p className="quote-atmosphere-kicker">
                                        Selge ülevaade enne, kui pakkumist küsid
                                    </p>
                                </div>

                                <div className="quote-facts-grid">
                                    {QUICK_FACTS.map((fact) => (
                                        <div key={fact.label} className="quote-fact-card">
                                            <div className="quote-fact-icon">{fact.icon}</div>
                                ...
                                <div className="quote-steps-card">
                                    <p className="quote-steps-title">Kuidas see käib</p>
                                    <div className="quote-step-item">
                                        <span className="quote-step-index">01</span>
                                        <p>Kirjuta meile kuupäev, külaliste arv ja ürituse tüüp.</p>
                                    </div>
                                    <div className="quote-step-item">
                                        <span className="quote-step-index">02</span>
                                        <p>Võrdleme sinu soovid peosaali ja toitlustuse võimalustega.</p>
                                    </div>
                                    <div className="quote-step-item">
                                        <span className="quote-step-index">03</span>
                                        <p>Saad personaalse vastuse, mille põhjal on lihtne edasi otsustada.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
